  ...
  <div class="navbar bg-base-100 shadow-md">
    ...
    <div class="flex-none">
      <div class="dropdown dropdown-end">
        <CartIcon :count="cartStore?.count" />

        <div
          tabindex="0"
          class="mt-4 card card-compact dropdown-content w-52 bg-base-100 shadow"
        >
          <div class="card-body">
            ...
            <div class="card-actions">
              <NuxtLink :to="{ name: 'cart' }" class="w-full">
                <button class="btn-sm rounded-md btn-primary btn-block">View cart</button>
              </NuxtLink>
            </div>
          </div>
        </div>
